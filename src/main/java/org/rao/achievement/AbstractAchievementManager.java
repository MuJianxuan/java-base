...
import org.rao.redis.LockWrapper;
...
public abstract class AbstractAchievementManager implements AchievementManager, InitializingBean {
    ...
    public AbstractAchievementManager(RedissonClient redissonClient) {
    ...
    public void addAchievementValue(String userId, Long achievementValue) {
        ...
        // 计算成就达成算法，不封装了，后面要改再聚合成接口吧.......写不赢了卧槽
        ...
        RedissonDistributedLock.tryLock( lockWrapper,
                () -> {
    ...
    protected void recursiveCalculationReachAchievement(String userId ,Long achievementValue ,Long achievementReachNextStageValue,
        ...
        if( achievementValue >= achievementReachNextStageValue ){
            ...
            Long nextAchievementStageValue = Optional.ofNullable( this.achievementStage.nextAchievementStageValue(nextInState) ).orElse(0L) - this.achievementStage.nextAchievementStageValue( currentInStage);
